...
country = {
    ...
    CONSERVATIVE_INCREASE_AFTER_REFORM = 0.05, -- how many more conservatives in a upper house.
    ...
    INVESTMENT_SCORE_FACTOR = 0.000001, -- how much foreign investment money counts towards your industry score
    ...
    RESEARCH_POINTS_ON_CONQUER_MULT = 2000, -- multiplier to RP got by conquering as unciv when got enacted military reforms
    MAX_RESEARCH_POINTS = 1000000, -- max RP you can store for uncivs
},
...
military = {
    ...
    GAS_ATTACK_MODIFIER = 8,
    COMBATLOSS_WAR_EXHAUSTION = 0.075, -- base war exhaustion in combat
    LEADER_MAX_RANDOM_PRESTIGE = 0.001, -- max percent of prestige, when randomizing stats for leaders.
    LEADER_AGE_DEATH_FACTOR = 1, -- higher value means leaders live longer
...
diplomacy = {
    ...
    INFAMY_ADD_TO_SPHERE = 2.5,
    INFAMY_RELEASE_PUPPET = 4.5,
    INFAMY_MAKE_PUPPET = 15,
    INFAMY_DISARMAMENT = 5,
    INFAMY_DESTROY_FORTS = 2.5,
    INFAMY_DESTROY_NAVAL_BASES = 2.5,
    ...
    CRISIS_BASE_CHANCE = 25,
    CRISIS_TEMPERATURE_INCREASE = 0.0125,
...
pops = {
    ...
    LITERACY_CHANGE_SPEED = 0.25,

    ASSIMILATION_SCALE = 0.075,
    CONVERSION_SCALE = 0.075,
    IMMIGRATION_SCALE = 0.075,
